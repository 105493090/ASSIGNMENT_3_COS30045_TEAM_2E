function init() {
    ...
    d3.csv("data/data.csv").then(function(data) {
        ...
        // Filter to obesity and overweight
        ...
        d3.selectAll("#measureButtons button").on("click", function() {
            ...
            if (label === "Obese") {
                currentMeasure = "Share of population who are obese";
            } else {
                currentMeasure = "Share of population who are overweight";
            }
        ...
        function updateChart() {
            ...
            var label = currentMeasure === "Share of population who are obese" ? "obese" : "overweight";
            caption.text("Fig 1. Share of population who are " + label + " (Total, " + currentYear + "). Source: OECD Health Statistics.");
        }
